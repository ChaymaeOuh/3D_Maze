...
/**
 * untextured_roof - Draws untextured ceiling to the screen
...
void untextured_roof(sdl_instance *sdl)
{
	...
	REND_COLOR(sdl->renderer, 25, 26, 255, 255);
...
void untextured_floor(sdl_instance *sdl)
{
	...
	REND_COLOR(sdl->renderer, 23, 204, 255, 255);
	SDL_RenderFillRect(sdl->renderer, &sky_dome);
}
 ...
 * @hitp: Pointer to sdl point structure. The point where the two lines meet
 *
