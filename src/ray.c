...
/**
 * rotate_point - rotates an SDL_Point by degrees
 * @point: the cartesean point to rotate
 * @cx: x coordinate of the arbitrary center
 * @cy: y coordinate of the arbitrary center
 * @deg: The degrees to rotate the point.(in radian)
 * @ray_size: The length of the casted ray
 *
 * Return: SDL_Point after rotation
 */
 ...
 * @sdl: sdl_instance
 * @player: player
 * @map: map_t the map information
 * @map_active: displayed or not
 */
